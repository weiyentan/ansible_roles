Function Start-WUDetectNow
{
    <#
	.SYNOPSIS
	    Start Windows Update detect.

	.DESCRIPTION
	    Use Start-WUDetectNow to begins automatic updating. It use default Auto Update settings only.
